...
namespace Vox {
	public class SphereDestroyer : SphereModifier {
		...
		private SphereDestroyer(VoxelTree control, Vector3 worldPosition, float worldRadius, VoxelHolder value, bool updateMesh)
			: base(control, worldPosition, worldRadius, value, updateMesh) {
		}

		public SphereDestroyer(VoxelTree control, Vector3 worldPosition, float worldRadius, VoxelHolder value, float maximumStrength, bool variableDestruction, bool updateMesh)
